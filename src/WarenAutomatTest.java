...
* Description: Test-Applikation um die Klassen-Bibliothek des Waren-Automaten 
               zu testen.
$Revision    : 1.12 $  $Date: 2017/05/31 11:21:15 $ 
/*///===========================================================================
//       1         2         3         4         5         6         7         8
...
public class WarenAutomatTest { 
  ...
  public static void main(String[] args) throws ParseException {
    ...
    { 
      ...
      automatOne.fuelleFach(2, "Zwei", 2.00, df.parse("01.01.2002"));
      ...
      System.out.println("Automat total warenwert: (EXPECT 4.0): " + automatOne.gibTotalenWarenWert());
